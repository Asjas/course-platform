...
export const testLessons = [
  // Module 1: Getting Started with Fastify
  {
    ...
    transcription: {
      ...
      // 5 cues: c0–c1 (Alice), c2–c3 (Bob), c4 (Alice at 1h mark).
      // Speaker change between c1→c2 triggers a paragraph break in buildParagraphs.
      // Large gap between c3 and c4 (>2.5 s) triggers a second paragraph break.
      // c4.startMs of 3 600 000 ms (1:00:00) exercises the hours branch in formatCueTime.
      cueCount: 5,
      durationMs: 3610000,
      cues: [
        {
          ...
          startMs: 0,
          endMs: 5000,
          text: "Welcome to the Fastify course.",
          speaker: "Alice",
        },
        {
          id: "c1",
        ...
        },
        {
          ...
          startMs: 13000,
          endMs: 20000,
          text: "It focuses on performance and developer experience.",
          speaker: "Bob",
        },
        {
          id: "c3",
          startMs: 20000,
          endMs: 28000,
          text: "In this course you will learn to build production-grade APIs.",
          speaker: "Bob",
        },
        {
          id: "c4",
  ...
  },
  {
    ...
    // Valid v1 schema with zero cues — exercises the "no_cues" ineligibility path
    // in resolveTranscript and renders "The transcript for this lesson is empty."
    transcription: {
      version: 1,
      language: "en",
      source: "manual",
  ...
  },
  {
    ...
    // Auto-generated v1 transcript — exercises the isAutoGenerated=true branch
    // and renders the "Auto" source badge in TranscriptPanel.
    transcription: {
      version: 1,
      language: "en",
      source: "auto",
