  ...
  return (
    <>
      <div className="relative">
        ...
        {type === "password" ? (
          <button
            className="text-muted-foreground focus-visible:ring-ring hover:text-foreground absolute right-0 top-1/2 -translate-y-1/2 rounded-md p-1 transition-colors hover:bg-gray-400 focus-visible:outline-none focus-visible:ring-2"
            type="button"
