  ...
  return (
    ...
    >
      ...
      >
          ...
          >
            ...
            >
              <div className="flex h-full flex-col">
                <textarea
                  className={cn(
                    "custom-scrollbar h-full min-h-[200px] w-full flex-1 resize-none rounded-lg border border-gray-300 bg-white p-3 text-sm",
        ...
        <SheetFooter className="border-t border-gray-200 pt-4 dark:border-gray-700">
          <button
            className={cn(
