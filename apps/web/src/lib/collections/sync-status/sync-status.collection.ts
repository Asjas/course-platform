 ...
 *
 * Offline-first collection for tracking sync status across collections.
 * Used to monitor and manage SSE sync state.
 */
...
/**
 * Sync status collection for tracking collection sync states.
 * Supports updates for managing sync state.
 */
