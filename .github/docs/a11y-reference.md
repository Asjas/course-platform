...
> Full accessibility patterns and code examples for WCAG 2.2 Level AA compliance.
> The slim version used by AI agents is in [instructions/a11y.instructions.md](../instructions/a11y.instructions.md).
